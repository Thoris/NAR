...
namespace NAR.Tests.Confiability
{
    public sealed class TypeLoader
    {
        ...
        public static IReport CreateTypeReport(string fullTypeName, params string [] param)
        {
            object result = CreateType("NAR.Tests.Confiability", fullTypeName, param);

            return (IReport)result;
        }
        public static NAR.ImageProcessing.Borders.IBorderDetector CreateTypeBorder(string fullTypeName)
        {
            object result = CreateTypeByFullTypeName(fullTypeName);

            return (NAR.ImageProcessing.Borders.IBorderDetector)result;
        }
        #endregion
    }
}
