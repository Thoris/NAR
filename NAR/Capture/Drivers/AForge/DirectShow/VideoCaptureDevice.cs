...
namespace NAR.Capture.Drivers.AForge.DirectShow
{
    ...
    using AForge.Video;
    using AForge.DirectShow.Internals;
    ...
    public class VideoCaptureDevice : IVideoSource
    {
        ...
        private void WorkerThread( bool runGraph )
        {
            ...
            //Grabber currentFrameGrabber = new Grabber(this, false);
            ...
            //object currentFrameGrabberObject = null;
            ...
            //IBaseFilter currentFrameGrabberBase = null;
            //ISampleGrabber currentVideoFrameGrabber = null;
            ...
            try
            {
                ...
                //currentFrameGrabberObject = Activator.CreateInstance(type);
                //currentVideoFrameGrabber = (ISampleGrabber)currentFrameGrabberObject;
                //currentFrameGrabberBase = (IBaseFilter)currentFrameGrabberObject;
                ...
                //currentVideoFrameGrabber.SetMediaType(mediaType);
                ...
                //currentVideoFrameGrabber.SetBufferSamples(true);
                //currentVideoFrameGrabber.SetOneShot(false);
                //currentVideoFrameGrabber.SetCallback(currentFrameGrabber, 1);
                ...
                if ( runGraph )
                {
                    ...
                    //if (currentVideoFrameGrabber.GetConnectedMediaType(mediaType) == 0)
                    //{
                    //    VideoInfoHeader vih = (VideoInfoHeader)Marshal.PtrToStructure(mediaType.FormatPtr, typeof(VideoInfoHeader));

                    //    currentFrameGrabber.Width = vih.BmiHeader.Width;
                    //    currentFrameGrabber.Height = vih.BmiHeader.Height;
            ...
            finally
            {
                ...
                //currentFrameGrabber = null;
                //currentFrameGrabberBase = null;
                ...
                //if (currentVideoFrameGrabber != null)
                //{
                //    Marshal.ReleaseComObject(currentVideoFrameGrabber);
                //    currentVideoFrameGrabber = null;
                //}
            }
                ...
                if ( streamConfig != null )
                {
                    if ( capabilities == null )
                    {
                        try
                        {
                            ...
                            capabilities = AForge.DirectShow.VideoCapabilities.FromStreamConfig( streamConfig );
                        }
                        catch
                        {
                        }
        ...
        //        videoSampleGrabber.GetCurrentBuffer(ref val, val2);
        //    return null;
        //}
        #endregion
