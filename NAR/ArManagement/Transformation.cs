...
namespace NAR.ArManagement
{
    ...
    {
        public const double MD_PI = 3.14159265358979323846;
        public const int P_MAX = 500;


        public const int AR_GET_TRANS_MAT_MAX_LOOP_COUNT = 5;
        public const double AR_GET_TRANS_MAT_MAX_FIT_ERROR = 1.0;
        public const double AR_GET_TRANS_CONT_MAT_MAX_FIT_ERROR = 1.0;


        //---------------------------

        int arGetAngle(double[,] rot, double wa, double wb, double wc)
        {
            double a, b, c;
...
for(i=0;i<3;i++) rot[i][2] = w[i];
        ...
        int arGetRot(double a, double b, double c, double[,] rot)
        {
    ...
    for(i=0;i<3;i++) rot[i][0] = w[i];
        ...
        public int arGetNewMatrix(double a, double b, double c, double[] trans, double[,] trans2, double[,] cpara, double[,] ret)
        {
        ...
        int arGetInitRot(Objects.ARMarkerInfo marker_info, double[,] cpara, double[,] rot)
        {
            ...
            //            if (check_dir(wdir[0], marker_info.Vertex[(4 - dir) % 4], marker_info.Vertex[(5 - dir) % 4], cpara) < 0) return -1;
            //            if (check_dir(wdir[1], marker_info.Vertex[(7 - dir) % 4], marker_info.Vertex[(4 - dir) % 4], cpara) < 0) return -1;
        ...
        int check_dir(double[] dir, double[] st, double[] ed, double[,] cpara)
        {
            Objects.ARMat mat_a;
        ...
        double arModifyMatrix(double[,] rot, double[] trans, double[,] cpara, double[,] vertex, double[,] pos2d, int num)
        {
            double factor;
            double a = 0, b = 0, c = 0;
            double a1, b1, c1;
        ...
        double arsModifyMatrix(double[,] rot, double[] trans, Objects.ARSParam arsParam, double[,] pos3dL, double[,] pos2dL, int numL, double[,] pos3dR, double[,] pos2dR, int numR)
        {
            double factor;
            double a = 0, b = 0, c = 0;
            double a1, b1, c1;
        ...
        Objects.ARParam arParam = new Objects.ARParam();
        ...
        double[,] pos2d = new double[P_MAX, 2];
        double[,] pos3d = new double[P_MAX, 3];





        double arGetTransMat(Objects.ARMarkerInfo marker_info, double[] center, double width, double[,] conv)
        {
            double[,] rot = new double[3, 3];
            ...
            {
                err = arGetTransMat3(rot, ppos2d, ppos3d, 4, conv, arParam.dist_factor, arParam.mat);
                if (err < AR_GET_TRANS_MAT_MAX_FIT_ERROR) break;
            }
            return err;
        }
        double arGetTransMat2(double[,] rot, double[,] ppos2d, double[,] ppos3d, int num, double[,] conv)
        {
            return arGetTransMat3(rot, ppos2d, ppos3d, num, conv, arParam.dist_factor, arParam.mat);
        }
        double arGetTransMat3(double[,] rot, double[,] ppos2d, double[,] ppos3d, int num, double[,] conv, double[] dist_factor, double[,] cpara)
        {
            ...
            ret = arGetTransMatSub(rot, ppos2d, pos3d, num, conv, dist_factor, cpara);
        ...
        double arGetTransMat4(double[,] rot, double[,] ppos2d, double[,] ppos3d, int num, double[,] conv)
        {
            return arGetTransMat5(rot, ppos2d, ppos3d, num, conv, arParam.dist_factor, arParam.mat);
        }
        double arGetTransMat5(double[,] rot, double[,] ppos2d, double[,] ppos3d, int num, double[,] conv, double[] dist_factor, double[,] cpara)
        {
            double[] off = new double[3];
            double[] pmax = new double[3];
            double[] pmin = new double[3];
        ...
        double arGetTransMatSub(double[,] rot, double[,] ppos2d, double[,] pos3d, int num, double[,] conv, double[] dist_factor, double[,] cpara)
        {
            Objects.ARMat mat_a, mat_b, mat_c, mat_d, mat_e, mat_f;
        ...
        double arGetTransMatCont(Objects.ARMarkerInfo marker_info, double[,] prev_conv, double[] center, double width, double[,] conv)
        {
            double err1, err2;
            double[,] wtrans = new double[3, 4];
            int i, j;
        ...
        double arGetTransMatContSub(Objects.ARMarkerInfo marker_info, double[,] prev_conv, double[] center, double width, double[,] conv)
        {
            double[,] rot = new double[3, 3];
            double[,] ppos2d = new double[4, 2];
            double[,] ppos3d = new double[4, 2];
