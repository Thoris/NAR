...
{
    [TestFixture]
    public class KitchenRosenfeldCornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.KitchenRosenfeldCornersCommand test =
                new NAR.ImageProcessing.Corner.KitchenRosenfeldCornersCommand(true);
