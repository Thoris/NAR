...
{
    [TestFixture]
    public class BeaudetCornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            //NAR.ImageProcessing.Corner.BeaudetCornersCommand test =
            //    new NAR.ImageProcessing.Corner.BeaudetCornersCommand(true);
