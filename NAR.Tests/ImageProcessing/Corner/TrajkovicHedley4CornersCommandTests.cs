...
{
    [TestFixture]
    public class TrajkovicHedley4CornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.TrajkovicHedley4CornersCommand test =
                new NAR.ImageProcessing.Corner.TrajkovicHedley4CornersCommand(true);
