...
{
    [TestFixture]
    public class TrajkovicHedley8CornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.TrajkovicHedley8CornersCommand test =
                new NAR.ImageProcessing.Corner.TrajkovicHedley8CornersCommand(true);
