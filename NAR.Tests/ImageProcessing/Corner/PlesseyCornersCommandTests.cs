...
{
    [TestFixture]
    public class PlesseyCornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.PlesseyCornersCommand test =
                new NAR.ImageProcessing.Corner.PlesseyCornersCommand(true);
