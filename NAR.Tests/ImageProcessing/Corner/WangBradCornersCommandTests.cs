...
{
    [TestFixture]
    public class WangBradCornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.WangBradCornersCommand test =
                new NAR.ImageProcessing.Corner.WangBradCornersCommand(true);
