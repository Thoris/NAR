...
{
    [TestFixture]
    public class ZhengWangCornersCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Corner.ZhengWangCornersCommand test =
                new NAR.ImageProcessing.Corner.ZhengWangCornersCommand(true);
