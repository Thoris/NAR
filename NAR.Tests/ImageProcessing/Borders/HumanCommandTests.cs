...
{
    [TestFixture]
    public class HumanCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Borders.HumanCommand test = new NAR.ImageProcessing.Borders.HumanCommand(false);
        ...
        {
            //NAR.ImageProcessing.Borders.HumanCommand test = new NAR.ImageProcessing.Borders.HumanCommand(true);
