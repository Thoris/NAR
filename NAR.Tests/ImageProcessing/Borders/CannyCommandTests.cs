...
{
    [TestFixture]
    public class CannyCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Borders.CannyCommand test = new NAR.ImageProcessing.Borders.CannyCommand(false);
        ...
        {
            NAR.ImageProcessing.Borders.CannyCommand test = new NAR.ImageProcessing.Borders.CannyCommand(true);
