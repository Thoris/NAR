...
{
    [TestFixture]
    public class MarrHildrethCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Borders.MarrHildrethCommand test = new NAR.ImageProcessing.Borders.MarrHildrethCommand(false);
        ...
        {
            //NAR.ImageProcessing.Borders.MarrHildrethCommand test = new NAR.ImageProcessing.Borders.MarrHildrethCommand(true);
