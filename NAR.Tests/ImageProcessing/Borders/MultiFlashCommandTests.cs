...
{
    [TestFixture]
    public class MultiFlashCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Borders.MultiFlashCommand test = new NAR.ImageProcessing.Borders.MultiFlashCommand(false);
        ...
        {
            //NAR.ImageProcessing.Borders.MultiFlashCommand test = new NAR.ImageProcessing.Borders.MultiFlashCommand(true);
