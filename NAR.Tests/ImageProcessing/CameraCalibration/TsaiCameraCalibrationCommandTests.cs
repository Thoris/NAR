...
namespace NAR.Tests.ImageProcessing.CameraCalibration
{
    [TestFixture]
    public class TsaiCameraCalibrationCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.CameraCalibration.TsaiCameraCalibrationCommand test =
                new NAR.ImageProcessing.CameraCalibration.TsaiCameraCalibrationCommand();
