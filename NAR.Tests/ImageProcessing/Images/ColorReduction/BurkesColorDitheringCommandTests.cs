...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class BurkesColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.BurkesColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.BurkesColorDitheringCommand();
