...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class ColorImageQuantizerCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.ColorImageQuantizerCommand test = new NAR.ImageProcessing.Images.ColorReduction.ColorImageQuantizerCommand();
