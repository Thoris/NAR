...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class ColorErrorDiffusionToAdjacentNeighborsCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.ColorErrorDiffusionToAdjacentNeighborsCommand test = new NAR.ImageProcessing.Images.ColorReduction.ColorErrorDiffusionToAdjacentNeighborsCommand();
