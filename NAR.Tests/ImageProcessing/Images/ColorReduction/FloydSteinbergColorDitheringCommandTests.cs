...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class FloydSteinbergColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.FloydSteinbergColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.FloydSteinbergColorDitheringCommand();
