...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class JarvisJudiceNinkeColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.JarvisJudiceNinkeColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.JarvisJudiceNinkeColorDitheringCommand();
