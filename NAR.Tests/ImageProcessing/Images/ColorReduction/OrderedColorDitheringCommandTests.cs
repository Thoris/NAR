...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class OrderedColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.OrderedColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.OrderedColorDitheringCommand();
