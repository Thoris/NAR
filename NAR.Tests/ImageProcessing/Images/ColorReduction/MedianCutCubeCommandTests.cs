...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class MedianCutCubeCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.MedianCutCubeCommand test = new NAR.ImageProcessing.Images.ColorReduction.MedianCutCubeCommand();
