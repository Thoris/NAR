...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class ErrorDiffusionColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.ErrorDiffusionColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.ErrorDiffusionColorDitheringCommand();
