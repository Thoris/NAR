...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class StuckiColorDitheringCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.StuckiColorDitheringCommand test = new NAR.ImageProcessing.Images.ColorReduction.StuckiColorDitheringCommand();
