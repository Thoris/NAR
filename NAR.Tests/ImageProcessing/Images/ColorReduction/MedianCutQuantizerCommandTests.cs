...
namespace NAR.Tests.ImageProcessing.Images.ColorReduction
{
    [TestFixture]
    [Ignore]
    public class MedianCutQuantizerCommandTests : BaseCommand
    {
        ...
        {
            NAR.ImageProcessing.Images.ColorReduction.MedianCutQuantizerCommand test = new NAR.ImageProcessing.Images.ColorReduction.MedianCutQuantizerCommand();
