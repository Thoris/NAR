...
{
    [TestFixture]
    public class OtsuThresholdCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Images.Binarization.Adaptative.OtsuThresholdCommand test = new NAR.ImageProcessing.Images.Binarization.Adaptative.OtsuThresholdCommand();
