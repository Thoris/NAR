...
{
    [TestFixture]
    public class IterativeThresholdCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Images.Binarization.Adaptative.IterativeThresholdCommand test = new NAR.ImageProcessing.Images.Binarization.Adaptative.IterativeThresholdCommand();
