...
{
    [TestFixture]
    public class ErrorDiffusionToAdjacentNeighborsCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Images.Binarization.ErrorDiffusionToAdjacentNeighborsCommand test = new NAR.ImageProcessing.Images.Binarization.ErrorDiffusionToAdjacentNeighborsCommand();
