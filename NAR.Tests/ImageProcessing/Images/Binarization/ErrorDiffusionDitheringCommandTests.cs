...
{
    [TestFixture]
    public class ErrorDiffusionDitheringCommandTests : BaseCommand
    {
        ...
        {
            //NAR.ImageProcessing.Images.Binarization.ErrorDiffusionDitheringCommand test = new NAR.ImageProcessing.Images.Binarization.ErrorDiffusionDitheringCommand();
