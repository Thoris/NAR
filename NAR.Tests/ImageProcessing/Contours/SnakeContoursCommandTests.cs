...
{
    [TestFixture]
    public class SnakeBlobCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Contours.SnakeContoursCommand test =
                new NAR.ImageProcessing.Contours.SnakeContoursCommand();
