...
{
    [TestFixture]
    public class RadialSweepBlobCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Contours.RadialSweepContoursCommand test =
                new NAR.ImageProcessing.Contours.RadialSweepContoursCommand(true);
