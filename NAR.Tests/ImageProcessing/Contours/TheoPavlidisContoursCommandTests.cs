...
{
    [TestFixture]
    public class TheoPavlidisBlobCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Contours.TheoPavlidisContoursCommand test =
                new NAR.ImageProcessing.Contours.TheoPavlidisContoursCommand();
