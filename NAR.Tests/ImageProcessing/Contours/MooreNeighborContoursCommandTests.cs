...
{
    [TestFixture]
    public class MooreNeighborBlobCommandTests : BaseCommand
    {
        ...
        public void TestExecute()
        {
            ...
            NAR.ImageProcessing.Contours.MooreNeighborContoursCommand test =
                new NAR.ImageProcessing.Contours.MooreNeighborContoursCommand(true);
